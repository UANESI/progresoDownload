...
class zipfile
{
    ...
    /**
     * Agregado a la clase original
     *
     * Creado por Tahel Romero - Phanor Coll 2 noviembre 2006
     *
	...
	function archivo_virtual($file)
    {
		if(ini_get('zlib.output_compression')){
			ini_set('zlib.output_compression', 'Off');
		}
		$ctype="application/zip";
		$archivoRetorno = $this->file();
		...
		header("Content-Length: ".strlen($archivoRetorno));
		echo $archivoRetorno;
		exit();
