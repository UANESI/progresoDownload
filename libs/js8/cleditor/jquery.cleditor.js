...
(function ($) {
    ...
    function createPopup(popupName, options, popupTypeClass, popupContent, popupHover) {
        ...
        // URL
            ...
            $popup.html('<label>Ingrese la Dirección URL:<br /><input type="text" value="http://" style="width:200px" /></label><br /><input type="button" value="Aceptar" />');
            popupTypeClass = PROMPT_CLASS;
        }

        // Paste as Text
        else if (popupName === "pastetext") {
            $popup.html('<label>Copie el texto acá:<br /><textarea rows="4" style="width:200px"></textarea></label><br /><input type="button" value="Agregar" />');
            popupTypeClass = PROMPT_CLASS;
        }
	...
	function cambiaTexto(editor,texto) {
		//alert(texto);
		$(editor.doc.body).html(texto);
