...
if (window.METRO_LOCALE === undefined) window.METRO_LOCALE = 'ES_es';
...
$.widget( "metro.donut" , {
    ...
    _createDonut: function(){
		...
		html += "   <text   class='donut-title' x='"+(o.radius)+"px' y='"+(o.radius)+"px' dy='"+fontSize3+"px' text-anchor='middle' fill='"+(o.fill)+"' font-size='"+(fontSize)+"px'>0"+(o.cap)+"</text>";
        html += "</svg>";
...
$.widget("metro.popover", {
	...
	oculta:function(){var popover=this.popover;popover.hide()},
    _destroy: function(){
    },
    _destroy: function(){
    },
